...
//
const BotName = 'lightBOT v2'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/fahrixganz'; // Nama Instagramlu cok
const whatsapplu = '0838-5670-0931'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = '*LAGI PROSES*'; // OFFICIAL GRUP LU 1
const grupch2 = '*LAGI PROSES*'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.sendMessage(id, 'Owner fahri wa.me/6283856700931' ,MessageType.text);
}
...
//Tolonglah bro jangan di ubah ubah FAHRI GANZ
